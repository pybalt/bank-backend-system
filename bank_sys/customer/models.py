...
class Customer(models.Model):
    ...
    id = models.AutoField(primary_key=True, unique=True, verbose_name = 'ID')
    user = models.OneToOneField(User, verbose_name="User", unique=True, to_field = "id", on_delete=models.CASCADE)
    ...
    customer_type = models.ForeignKey(CustomerType, verbose_name="Customer type", on_delete=models.CASCADE)
